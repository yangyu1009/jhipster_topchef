...
import topchef.service.dto.tableEntity.*;
import topchef.service.mapper.*;
import topchef.repository.TableSearchDao;
...
public class TableSearchService implements TableSearchDao {
    ...
    public List<UserDto> getAllUsers() {
        ...
        List<UserDto> users = jdbcTemplateObject.query(sql, new UserInfoMapper());
        return users.stream()
            .map(user -> {
    ...
    public UserDto getUserById(String userId) {
        ...
        UserDto user = jdbcTemplateObject.queryForObject(sql,new Object[]{userId}, new UserInfoMapper());
        return user;
    }
